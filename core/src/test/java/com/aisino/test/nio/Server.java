...
public class Server {
    ...
    class Reader extends Thread {
        ...
        Reader(int i) throws IOException {
            ...
            System.err.println("Starting Reader-" + i + "...");
        }
                ...
                try {
                    if (key == null) {
                        try {
                            ...
                            System.err.println("the client went away"+ e);
                        }
                    } else {
        ...
        private void doAsyncWrite(SelectionKey key) throws IOException {
            ...
            if(numBytes < 0 || call.response.remaining() == 0) {
                try {
                    ...
                    System.err.println("Exception while changing ops : " + e);
                }
            }
        }
    ...
    class Handler extends Thread {
        ...
        public Handler(int i) {
            setName("handler-" + i);
            System.err.println("Starting Handler-" + i + "...");
        }
        ...
        public void process(Call call) throws IOException {
            ...
            System.err.println("received mseesage: " + message);
